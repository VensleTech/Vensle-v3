...
const GrocePop = ({id,  title, price, img, imgfolder, information,  getreadstate}) => {
    ...
    const [cat_name, item_contact_number, state, country] = information
                    ...
                    openchat === false ?
                      <div className="dr-first">
                          ...
                          <div className='bottom'>
                              <Link to={"/grocery/"+id+"/"+cat_name.trim().replaceAll(' ', '-').replaceAll('/', '&')+"/"+title.trim().replaceAll(' ', '-').replaceAll('/', '&')} onClick={billy}><div className='more-details' onClick={bill}>
