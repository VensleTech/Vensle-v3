...
const Request = () => {
    ...
    const getminprice = (name)=> {
        setpayload({...payload, min_price:name})
    }
    const getmaxprice = (name)=> {
        setpayload({...payload, max_price:name})
    }
                            ...
                            <div className="adm-main-left" style={{display:'grid', gap:'30px'}}>
                                <div>
                                        ...
                                        <div className="adm-main-second" style={{display:'grid', gridTemplateColumns:'100%'}}>
                                            ...
                                            <Input title={'Minimum price'} icon={currency} type={"currcombo"} getreadstate={getminprice}/>
                                            <Input title={'Maximum price'} icon={currency} type={"currcombo"} getreadstate={getmaxprice}/>
                                        </div>
                                </div>
