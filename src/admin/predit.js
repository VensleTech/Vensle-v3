            ...
            <div className="admin-sec">
                ...
                <div className="adm-main">
                    ...
                    <div className="table-container">
                        ...
                        <button onClick={formreset} style={{marginTop:'30px', backgroundColor:'rgb(219 219 219)', color:'black', display:'inline-flex', gap:'20px'}}><FontAwesomeIcon icon={faEraser}/> Reset</button>
                        </div>
                    </div>
                </div>
                {
