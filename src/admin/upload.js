...
const Upload = () => {
    ...
    const axe =async (e)=>{
        ...
        data.append('partner_id', '33');
        data.append('title', payload.title);
        data.append('pricetype', payload.pricetype);
            ...
            <div className="admin-sec">
                ...
                <div className="adm-main">
                    ...
                    <div className="top-trending">
                        <h3>Upload Regular Product</h3>
                        <div className="location2"> <FontAwesomeIcon icon={faLocationDot} />{location}</div>
                    </div>
                        ...
                        <div className="adm-main-second" style={{display:'grid', gridTemplateColumns:'60% 37%', gap:'3%'}}>
                            <div className="adm-main-left" style={{display:'grid', gap:'30px'}}>
                                <div>
                                    <h5>Taxonomy</h5>
                                        ...
                                        <div className="adm-main-second" style={{display:'grid', gridTemplateColumns:'repeat(2, 49%)', gap:'1%'}}>
                                            <Input title={'Price type'} icon={''} type={"radio"} name={'pricetype'} content={['Negotiable', 'Non-negotiable']} getreadstate={getpricetype}/>
                                            <Input title={'Item price'} icon={''} type={"currcombo"} getreadstate={getprice}/>
                                            <Input title={'Quantity'} icon={''} type={"number"} getreadstate={getquantity} />
                                        </div>
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <div className="location"><FontAwesomeIcon icon={faLocationDot} /> {location} <span>Change</span></div>
                                </div>
