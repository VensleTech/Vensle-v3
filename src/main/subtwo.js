    ...
    return(
        <div>
            <div>
                ...
                <div><Link to={'/'}>Home</Link> <FontAwesomeIcon icon={faAngleRight} /> {path[3]} <FontAwesomeIcon icon={faAngleRight} /> <Link to={'/'+path[0]+'/'+catid+'/'+name+'/'+parid+'/'+parname}>{parname} </Link><FontAwesomeIcon icon={faAngleRight} /> {name}</div>
            </div>
            <div className="main">
