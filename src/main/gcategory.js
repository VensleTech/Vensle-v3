                            ...
                            <h4>{name}</h4>
                                <div className="submenu">
                                {
                                    catone.map(({id,name:n,image})=>(
                                        <div>
                                        <Link to={'/g/'+catid+'/'+name+'/'+id+'/'+n}><p>{n}</p></Link>
                                        </div>
                                    ))
                                }
                                </div>
                    ...
                    {style === 1 ? 
                        <div className="mr-third">
                        {
                            product.map((product, i)=>(
                                <div><Pcards type={4} width={217} height={330} vim={'100%'} information={product} route={'gro'}/></div>
                            ))
                        }
                        </div> :
                        ...
                        {
                            product.map((product, i)=>(
                                <div><Pcards type={2} width={'100%'} height={'150px'} pdsize={'1.3em'} pcsize={'1.8em'} information={product} route={'gro'}/></div>
                            ))
                        }
                        </div>
                    }
